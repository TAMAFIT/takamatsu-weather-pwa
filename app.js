(() => {
  ...
  function judgeDay(baseRows,jmaRows,marineRows,amedas,selectedDate){
    ...
    const compareNote=buildCompareNote({modelDiff,jmaGood,goodHours,amedas,selectedDate,waveMax});
    return{score,gradeKey,symbol,title,icon,reason,goodHours,cloudAvg,sunHours,uvMax,rainLevel,tanLevel,marineLabel,confidence,bestTime,compareNote,marineByHour}
  }
